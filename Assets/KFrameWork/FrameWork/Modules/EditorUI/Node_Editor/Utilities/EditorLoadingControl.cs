...
namespace NodeEditorFramework.Utilities
{
	...
	public static class EditorLoadingControl 
	{
		...
		{
			//LogMgr.Log ("Playmode State Change! isPlaying: " + Application.isPlaying + "; Serialized: " + serializationTest);
			if (!Application.isPlaying)
			{ // Edit Mode
				if (playmodeSwitchToEdit)
				{ // After Playmode
					//LogMgr.Log ("LOAD PLAY MODE Values in Edit Mode!!");
				...
				{ // Before Playmode
					//LogMgr.Log ("SAVE EDIT MODE Values before Play Mode!!");
			...
			{ // Play Mode
				...
				{ // Before Leaving Playmode
					//LogMgr.Log ("SAVE PLAY MODE Values before Edit Mode!!");
				...
				{ // After Entering Playmode
					//LogMgr.Log ("LOAD EDIT MODE Values in Play Mode!!");
