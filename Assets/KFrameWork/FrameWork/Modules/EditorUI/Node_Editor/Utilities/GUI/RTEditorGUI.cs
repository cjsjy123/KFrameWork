	...
	public static class RTEditorGUI 
	{
		...
		public static bool EndChangeCheck () 
		{
			...
			if (changeStack.Count > 0)
			{
				...
				LogMgr.LogWarning ("Requesting more EndChangeChecks than issuing BeginChangeChecks!");
			return changed;
		}
		...
		public static float ForceParse (this string str) 
		{
			...
			if (!float.TryParse (str, out value))
				LogMgr.LogError ("Could not parse " + str);
			return value;
		}
		...
		private static void SetupLineMat (Texture tex, Color col) 
		{
			...
			if (tex == null)
				tex = lineTexture != null? lineTexture : lineTexture = NodeEditorFramework.Utilities.NodeResourceManager.LoadTexture ("Textures/AALine.png");
