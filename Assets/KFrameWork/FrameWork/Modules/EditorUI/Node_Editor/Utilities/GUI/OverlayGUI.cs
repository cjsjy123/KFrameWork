...
namespace NodeEditorFramework.Utilities 
{
	...
	public class PopupMenu 
	{
		...
		public void SetupGUI () 
		{
			...
			expandRight = NodeResourceManager.LoadTexture ("Textures/expandRight.png");
		...
		private MenuItem AddHierarchy (ref GUIContent content, out string path) 
		{
			...
			{ // is inside a group
				...
				for (int groupCnt = 1; groupCnt < subContents.Length-1; groupCnt++)
				{
					...
					folderPath += "/" + folder;
					if (parent == null)
						LogMgr.LogError ("Parent is null!");
					else if (parent.subItems == null)
						LogMgr.LogError ("Subitems of " + parent.content.text + " is null!");
