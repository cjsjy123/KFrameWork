...
namespace KUtils
{
    ...
    public static class FrameWorkTools
    {
        ...
        public static void DestorySelf(this Transform tr)
        {
            if(tr != null)
        ...
        {
            Transform trans =  g.transform.FindChild(findname);
            if (trans == null)
            {
        ...
        public static GameObject InstantiatePrefab(this Component parent, GameObject prefab, bool worldPositionStays = false)
        {
            return parent.gameObject.InstantiatePrefab(prefab, worldPositionStays);
        }


        public static GameObject InstantiatePrefab(this GameObject parent, GameObject prefab, bool worldPositionStays =false)
        {
        ...
        public static GameObject InstantiatePrefab(this GameObject parent, Transform prefab, bool worldPositionStays = true)
        {
        ...
        public static GameObject AddInstance(this GameObject parent, GameObject ins, bool worldPositionStays = true)
        {
        ...
        public static GameObject AddInstance(this Component parent, GameObject ins, bool worldPositionStays = true)
        {
        ...
        public static GameObject AddInstance(this Component parent, Transform ins, bool worldPositionStays = true)
        {
        ...
        public static GameObject AddPrefab(this Component parent, GameObject prefab, bool worldPositionStays = true)
        {
            GameObject ins = GameObject.Instantiate(prefab);
        ...
        public static GameObject AddPrefab(this Component parent, Transform prefab, bool worldPositionStays = true)
        {
            GameObject ins = GameObject.Instantiate(prefab.gameObject);
